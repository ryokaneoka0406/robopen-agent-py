...
- Grafana Cloud Raspberry Pi integrationへjournald、`/var/log`、OSメトリクスを送信するAlloy導入手順を文書化する。
...
- Grafana Cloudの `Raspberry Pi / overview` と `Raspberry Pi / logs` でRaspberry Pi本体のメトリクスとログを確認できる。
